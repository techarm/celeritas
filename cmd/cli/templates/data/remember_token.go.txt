...
func (t *RemeberToken) Table() string {
	return "remember_tokens"
}

func (t *RemeberToken) InsertToken(userID int, token string) error {
...
func (t *RemeberToken) Delete(rememberToken string) error {
	collection := upper.Collection(t.Table())
